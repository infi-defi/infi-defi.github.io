...
Παρόλο που στο τέλος δεν υπέβαλαν όλοι όσοι πήραν μέρος, υπήρχαν ωραίες ιδέες και θα σας πρότεινα να [επισκεφθείτε τη σελίδα](https://itch.io/jam/organized-chaos-jam/entries) του διαγωνισμού για να δείτε τι έκανε ο καθένας.
## Τι έκανα εγω:

Αρχικά, είχα σκεφτεί να δημιουργήσω ένα arg, το οποίο θα ξεκινούσε με το να κατεβάζεις μια εικόνα μιας κάμπιας, και καθώς προχωρούσες και ανακαλύπτεις στοιχεία, η εικόνα θα μεταβαλλόταν σταδιακά, μέχρι να αποκαλυφθεί στο τέλος μια πεταλούδα. Παρότι εξακολουθώ να πιστεύω ότι αυτή ήταν μια καλή ιδέα για ένα project, η έλλειψη χρόνου λόγω πανελλαδικών με εμπόδισε από το να την υλοποιήσω. Παρ' όλα αυτά, ενδέχεται να την αναπτύξω στο μέλλον και να την μοιραστώ εδώ.
...
![Sketch](https://raw.githubusercontent.com/infi-defi/infi-defi.github.io/master/_posts/img/mirror_sketch.png)
_Sketch_

Μετα απο αυτο καθαρισα τις γραμμες και εβαλα καποια βασικα χρομματα.

![Clean lines](https://raw.githubusercontent.com/infi-defi/infi-defi.github.io/master/_posts/img/mirror_lineart.png)
_Clean lines_
![Basic colours](https://raw.githubusercontent.com/infi-defi/infi-defi.github.io/master/_posts/img/mirror_colour.png)
_Basic colours_
Εβαλα texture στο background και στα κομμάτια του καθρευτη

![Ο Riemann ήταν placeholder. Μεγάλη η χάρη του.](https://raw.githubusercontent.com/infi-defi/infi-defi.github.io/master/_posts/img/mirror_temp.png)
_Ο Riemann ήταν placeholder. Μεγάλη η χάρη του._
...
![Final result](https://raw.githubusercontent.com/infi-defi/infi-defi.github.io/master/_posts/img/mirror_fin.png)
_Final result_
